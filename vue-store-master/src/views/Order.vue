          ...
          <div class="order-bar-right">
            <span>
              ...
              <span class="total-price">
                <span v-if="total[index].totalPrice < 99">{{(total[index].totalPrice - item[0].discounts + 8).toFixed(2)}}</span>
                <span v-else>{{(total[index].totalPrice - item[0].discounts).toFixed(2)}}</span>
                元</span>
            </span>
          </div>
          <!-- 订单列表END -->
